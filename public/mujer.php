...
<head>
    ...
    <meta name="description" content="Chenati Sports - Zapatillas para Mujer">
    <title>Colección Mujer - Chenati Sports</title>
...
<body>
    ...
    <section class="category-header">
        <div class="category-header-content">
            ...
            <p>Descubre nuestras zapatillas de rendimiento diseñadas específicamente para mujeres</p>
    ...
    <section class="collection-section">
        <div class="collection-header">
            <h2 class="collection-title">Zapatillas para Mujer</h2>
        </div>
